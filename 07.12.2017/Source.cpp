...
start:
	...
	case 7:
		...
		int kod;
		int dp;
		cout << "Введите код города (Алматы-код 7272,Шымкент-код 7252,Астана-код 7172,Актау-код 7292): ";
		cin >> kod;
		...
		{
			int st = dp * 25;
			cout << "Алматы стоимость разговора составит " << st << endl;
		}
		break;
		case 7252:
		{
			int st = dp * 18;
			cout << "Шымкент стоимость разговора составит " << st << endl;
		}
		break;
		case 7172:
		{
			int st = dp * 13;
			cout << "Астана стоимость разговора составит " << st << endl;
		}
		break;
		case 7292:
		{
			int st = dp * 11;
			cout << "Актау стоимость разговора составит " << st << endl;
		}
		break;
